...
class HomeScreenViewModel extends ChangeNotifier {
  ...
  List<Video> filteredVideosByCategory(Category category){
      List<Category> filteredCategories = _categories.categories.where((item) => item.category == category.category && item.subCategory == category.subCategory).toList();
  ...
  String getTitleRecomended(Category category){
   ...
   } else if (category.category == "Ankthi" && category.subCategory == "LEHTESO"){
     return "Lehteso simptomet e ankthit";
   } else if (category.category == "Stresi" && category.subCategory == "MESO"){
      return "Meso per stresin";
   }else if (category.category == "Stresi" && category.subCategory == "LEHTESO"){
       return "Lehteso simptomet e stresit";
   } else if (category.category == "Depresioni" && category.subCategory == "MESO"){
     return "Meso per depresionin";
   }else if (category.category == "Depresioni" && category.subCategory == "LEHTESO"){
